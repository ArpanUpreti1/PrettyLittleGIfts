...
const ProductCard = ({ product, delay }) => (
  <motion.div
    className="bg-white rounded-xl shadow-lg border border-gray-100/80 overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
